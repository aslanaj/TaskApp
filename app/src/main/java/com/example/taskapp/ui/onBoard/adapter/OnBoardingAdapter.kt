...
private val data = arrayListOf(
    OnBoard("https://static.wixstatic.com/media/075ada_f52be7ec30464484add5b9fb9e849649~mv2.png/v1/fit/w_2500,h_1330,al_c/075ada_f52be7ec30464484add5b9fb9e849649~mv2.png",
        "Task Manager 1",
        "Task Manager"),
    OnBoard("https://flow-e.com/wp-content/uploads/bfi_thumb/Google-task-list-379tmv50jkyo35v5zqpoui.png",
        "Task Manager 2",
        "Task Manager"),
    OnBoard("https://kissflow.com/hubfs/task-management.jpg",
        "Task Manager 3",
        "Task Manager")
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnBoardingViewHolder {
        return  OnBoardingViewHolder(ItemOnboardingBinding
